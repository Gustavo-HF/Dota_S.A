...
public class Time {
    ...
    public Time(Integer classificacaoCampeonato, Integer classificacaoMundial, Long id, Boolean isUltimoCampeaoDoTi, String nome, Integer numeroJogadores, String regiao, List<Jogador> jogadores) {
